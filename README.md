...
- [GitHub Image Hosting](https://github.com/img402/skills/tree/main/skills/github-image-hosting) - Upload images to img402.dev and embed them in GitHub PRs, issues, and comments. No account or API key needed — one curl command. Images 1MB or under are free and permanent; up to 10MB is free for 30 days or permanent for $0.01 USDC via x402.
